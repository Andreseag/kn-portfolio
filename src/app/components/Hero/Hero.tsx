...
const Hero = () => {
  return (
    <section className="hero h-screen flex items-end justify-center w-full bg-[url(https://epvarquitectura.com.ar/wp-content/uploads/2024/06/25-1.webp)] bg-no-repeat">
